 ...
 * </p>
 * <ul>
 *   <li>{@link neuralnetwork.neuralnetwork.impl.ConcatenateImpl#getAxis <em>Axis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConcatenateImpl extends LayerImpl implements Concatenate {
	/**
	 ...
	 * @ordered
	 */
	protected static final int AXIS_EDEFAULT = -1;
	/**
	 ...
	 * @ordered
	 */
	protected int axis = AXIS_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return NeuralnetworkPackage.Literals.CONCATENATE;
	}
	...
	public void setAxis(int newAxis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NeuralnetworkPackage.CONCATENATE__AXIS, oldAxis,
					axis));
	}
